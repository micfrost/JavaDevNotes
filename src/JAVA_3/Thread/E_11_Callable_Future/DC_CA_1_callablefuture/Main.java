package JAVA_3.Thread.E_11_Callable_Future.DC_CA_1_callablefuture;
...
//        to a string is only saved the return
        ...
        System.out.println("JAVA_3.Thread completed: " + thread1);
        System.out.println("JAVA_3.Thread completed: " + thread2);
        System.out.println("JAVA_3.Thread completed: " + thread3);
